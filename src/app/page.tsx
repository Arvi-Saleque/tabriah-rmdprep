          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-2xl p-6 shadow-2xl text-white text-center transform hover:scale-105 transition-all">
                ...
                <p className="text-emerald-50">প্রথম ১০ জন ফাইনাল পরীক্ষায় স্ট্যান্ডার্ড নাম্বার পেলে ১ মাসের ফি ফেরত</p>
              </div>
            ...
            <div className="mt-8 bg-amber-50 border-2 border-amber-200 rounded-xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">চূড়ান্ত পরীক্ষায় একটি নির্দিষ্ট স্ট্যান্ডার্ড নম্বর অর্জন করলে প্রথম ১০ জন শিক্ষার্থীকে এক মাসের কোর্স ফি সম্পূর্ণ ফেরত দেওয়া হবে। এটি আপনার পরিশ্রমকে মূল্যায়ন করার একটি বিশেষ উদ্যোগ।</p>
                </div>
              </div>
            </div>
          </div>
