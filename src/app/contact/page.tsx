            ...
            <div className="bg-white rounded-xl shadow-xl p-8 md:p-12 mb-12">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-emerald-700 pl-6 py-2">
                  ...
                  <p className="text-gray-700">কোর্স ফি মাত্র <strong className="text-emerald-700"><span className="line-through opacity-60">২৯৯</span> ১৯৯ টাকা/মাস</strong> (মোট ২ মাস = ৩৯৮ টাকা)। প্রথম ১০ জন ১ মাসের ফি ফেরত পাবেন।</p>
                </div>
                <div className="border-l-4 border-emerald-700 pl-6 py-2">
